...
public :
   ...
   TLorentzVector *ltrueSigma;
   TLorentzVector *ltrueK0;  
...
void Convert::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("trueProton", &trueProton, &b_trueProton);
   fChain->SetBranchAddress("truePip", &truePip, &b_truePip);
   fChain->SetBranchAddress("truePim", &truePim, &b_truePim);
   fChain->SetBranchAddress("truePi0", &truePi0, &b_truePi0);
