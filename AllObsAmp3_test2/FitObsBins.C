...
//root --hsfit FitObsBins.C | tee out.log
{
  ...
  //////////////////////////Load Weights TEST 2
  //RF.Data().LoadWeights("Signal","/home/louise/g8K0Sig/code/sWeights3_test2/out_all_pi0K0_binned/Egamma1.23/Tweights.root");
  //RF.Data().LoadWeights("Signal","/home/louise/g8K0Sig/code/sWeights3_test2/out_all_pi0K0_binned/Egamma1.48/Tweights.root");
  //RF.Data().LoadWeights("Signal","/home/louise/g8K0Sig/code/sWeights3_test2/out_all_pi0K0_binned/Egamma1.73/Tweights.root");
  RF.Data().LoadWeights("Signal","/home/louise/g8K0Sig/code/sWeights3_test2/out_all_pi0K0_binned/Egamma1.98/Tweights.root");
