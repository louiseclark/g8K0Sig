void GetConvertPlots_MC() {
	
	TString inFileName = "/w/work0/home/louise/g8K0Sig/convert_output_MC/filepPi0_all.root";
	TFile* infile = TFile::Open(inFileName);
	TTree* tree = (TTree*)infile->Get("HSParticles");
	
	TString outdir = "/home/louise/g8K0Sig/AnalysisSummary/html/images/convert_MC/";
	...
	ofstream outfile;
    outfile.open("/home/louise/g8K0Sig/AnalysisSummary/html/convertCounts_MC.txt");
	...
	TString trVars[] = {"Egamma","t","phiSigma","cosX","cosY","cosZ","costhK0CMS"};
	float     xMin[] = {1.0,    -0.3, -3.14,    -1.0,  -1.0,  -1.0,  -1.0};
	float     xMax[] = {2.2,    2.2,  3.14,     1.0,   1.0,   1.0,   1.0};
	TString xTitle[] = {"E_{#gamma} (GeV)", "t (GeV^{2})", "#phi_{#Sigma^{+}}","cos #theta_{x}","cos #theta_{y}","cos #theta_{z}","cos #theta_{K^{0}}"};
