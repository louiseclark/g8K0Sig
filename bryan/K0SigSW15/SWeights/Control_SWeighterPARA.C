{
  //Set up the input chain to be analysed
   ...
   tree->Add("/home/bryanm/HSAna/Events-master/Projects/K0SigSW15/SWanaPARA.root");
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW15/SWeights/SWanaSWPARA.root");
   ...
   tree->Process("SWeighterPARA.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW15/SWeights/SWeights1PARA.root");
