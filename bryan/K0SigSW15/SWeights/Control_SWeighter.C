{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW/SWeights/SWanaSW.root");
   ...
   tree->Process("SWeighter.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW/SWeights/SWeights1.root");
