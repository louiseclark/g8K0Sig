{
  //Set up the input chain to be analysed
   ...
   tree->Add("/home/bryanm/HSAna/Events-master/Projects/K0SigSW15/SWanaPERP.root");
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW15/SWeights/SWanaSWPERP.root");
   ...
   tree->Process("SWeighterPERP.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW15/SWeights/SWeights1PERP.root");
