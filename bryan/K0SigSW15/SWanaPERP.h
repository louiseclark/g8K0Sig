...
class SWanaPERP : public TSelector, public THSOutput {
public :
  ...
  //e.g.   TLorentzVector  *fp1;
   ...
   SWanaPERP(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SWanaPERP() { }
...
//Add THSHisto functions
   ...
   ClassDef(SWanaPERP,0);
};

#endif

#ifdef SWanaPERP_cxx
void SWanaPERP::Init(TTree *tree)
{
