{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW19/SWeights/SWanaSWPERP.root");
   ...
   tree->Process("SWeighterPERP.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW19/SWeights/SWeights1PERP.root");
