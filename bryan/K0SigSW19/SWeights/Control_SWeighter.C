{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW19/SWeights/SWanaSW.root");
   ...
   tree->Process("SWeighter.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW19/SWeights/SWeights1.root");
