{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW19/SWeights/SWanaSWPARA.root");
   ...
   tree->Process("SWeighterPARA.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW19/SWeights/SWeights1PARA.root");
