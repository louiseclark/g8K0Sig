{
 ...
 FileName="/home/bryanm/new/LPS/testwolam3375.root";   // The input filename containing the tree
 TreeName="PartTree";   // The name of the tree
 OutName="test.root";   // The name of the output directory or file
 SelName="draw";    // The name of the selector to be produced
