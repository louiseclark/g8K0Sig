...
void SWanaPERP::Begin(TTree * /*tree*/)
{
...
void SWanaPERP::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t SWanaPERP::Process(Long64_t entry)
{
...
void SWanaPERP::HistogramList(TString sLabel){
...
void SWanaPERP::FillHistograms(TString sCut,Int_t bin){
  fCurrCut=sCut;
  fCurrBin=bin;
