{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW/SWeights/SWanaSWPARA.root");
   ...
   tree->Process("SWeighterPARA.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW/SWeights/SWeights1PARA.root");
