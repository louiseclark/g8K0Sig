...
#include "SWeighterPARA.h"
#include <TH2.h>
#include <TStyle.h>


void SWeighterPARA::Begin(TTree * /*tree*/)
{
...
void SWeighterPARA::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t SWeighterPARA::Process(Long64_t entry)
{
...
void SWeighterPARA::SlaveTerminate()
{
...
void SWeighterPARA::HistogramList(TString sLabel){
...
void SWeighterPARA::FillHistograms(TString sCut,Int_t bin){
  fCurrCut=sCut;
  fCurrBin=bin;
...
Bool_t SWeighterPARA::GetsWeight(){
