{
 ...
 FileName="/home/bryanm/kstree_eloss.root";   // The input filename containing the tree
 TreeName="PartTree";   // The name of the tree
 OutName="SWana.root";   // The name of the output directory or file
 SelName="SWana";    // The name of the selector to be produced
