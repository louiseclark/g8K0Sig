...
#ifndef SWeighterPERP_h
#define SWeighterPERP_h
...
class SWeighterPERP : public TSelector, public THSOutput {
public :
  ...
  //e.g.   TLorentzVector  *fp1;
   ...
   SWeighterPERP(TTree * /*tree*/ =0) : fChain(0),fCurrSW(0),fSWFile(0),fsPlotList(0),fSWKinBins(0) { }
   virtual ~SWeighterPERP() { }
...
//Add THSHisto functions
   ...
   ClassDef(SWeighterPERP,0);
};

#endif

#ifdef SWeighterPERP_cxx
void SWeighterPERP::Init(TTree *tree)
{
...
void SWeighterPERP::SetsPlot(Float_t ev1,Float_t ev2,Float_t ev3){
