{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW13/SWeights/SWanaSW.root");
   ...
   tree->Process("SWeighter.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW13/SWeights/SWeights1.root");
