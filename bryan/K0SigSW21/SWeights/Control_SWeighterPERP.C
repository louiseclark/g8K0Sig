{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW21/SWeights/SWanaSWPERP.root");
   ...
   tree->Process("SWeighterPERP.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW21/SWeights/SWeights1PERP.root");
