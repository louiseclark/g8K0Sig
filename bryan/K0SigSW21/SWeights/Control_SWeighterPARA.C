{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/bryanm/HSAna/Events-master/Projects/K0SigSW21/SWeights/SWanaSWPARA.root");
   ...
   tree->Process("SWeighterPARA.C++","/home/bryanm/HSAna/Events-master/Projects/K0SigSW21/SWeights/SWeights1PARA.root");
