...
TFile* outPlots=new TFile("SWeights1PERP.root","recreate"); //File to write sPlots to
/////////////////////////////////////////////////////////////////////

void SWeighter_sWeightPERP(){
  //Set up the input chain to be analysed
   TChain* tree=new TChain("HSParticles","datachain");
   tree->Add("/home/bryanm/HSAna/Events-master/Projects/K0SigSW21/SWanaPERP.root");
...
void Add1DModel(RooWorkspace* ws){
  ...
  model.graphVizTree("fullModelPERP.dot");
