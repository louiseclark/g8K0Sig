...
//root --hsfit FitObsBins.C | tee out.log
{
  ...
  RF.SetUp().LoadFormula("Cx=2.0*((@a1Im[]*@a4Re[]-@a1Re[]*@a4Im[]-@a2Re[]*@a3Im[]+@a2Im[]*@a3Re[])/@r[])");
  RF.SetUp().LoadFormula("Cz=2.0*((@a1Re[]*@a4Re[]+@a1Im[]*@a4Im[]-@a2Re[]*@a3Re[]-@a2Im[]*@a3Im[])/@r[])");
