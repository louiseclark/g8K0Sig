...
//If you want to split histograms into different kinematic bins, include and configure the lines below
   ...
   fBins->AddAxis("costhbins",6,binLimits);
   fBins->AddAxis("Ebins",1, 1.1, 1.35);
...
void histogrammer::SlaveBegin(TTree * /*tree*/)
{
   ...
   THSHisto::LoadWeights("/home/louise/g8K0Sig/code/sWeights3/out_all_pi0K0_binned/Egamma1.23/Tweights.root","HSsWeights");
