...
void GetValuesForGraph() {
	...
	std::string path = "/home/louise/g8K0Sig/code/AllObsAmp3_test14/out1/";
	...
	for (int obsNum=0; obsNum<7; obsNum++) {
		...
		std::string xArrString = "st14"+obs[obsNum]+"x=[";
		std::string yArrString = "st14"+obs[obsNum]+"y=[";
		std::string yErrArrString = "st14"+obs[obsNum]+"y_err=[";
