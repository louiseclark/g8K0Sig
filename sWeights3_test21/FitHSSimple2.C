...
//brufit FitHSSimple2.C
{
  ...
  ///////////////////////////////Load Variables
  RF.SetUp().LoadVariable("M_pip_pim[0.465,0.530]");//should be same name as variable in tree  
  ...
  RF.SetUp().FactoryPDF("Gaussian::Signal(M_pip_pim, SIMm[0.495,0.465,0.530], SIMw[0.004,0.001,0.008] )"); // limited signal width
