...
//root --hsfit FitObsBins.C | tee out.log
{
  ...
  /////////////////////////////Make Model Signal
  //  RF.SetUp().FactoryPDF("RooComponentsPDF::LinPolFit(1,{phiK0,pol,polState},=B;COS2)");
  RF.SetUp().FactoryPDF("RooComponentsPDF::LinPolFit(1,{phiK0,cosY,pol,polState},=R;alpha;cosY:B;COS2:T;alpha;cosY;COS2)");
  ...
  RF.SetMinimiser(new RooMcmcSeq(500,100,10));
