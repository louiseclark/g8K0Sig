...
//root --hsfit FitObsBins.C | tee out.log
{
  ...
  // Single bin
  //RF.Bins().LoadBinVar("costhK0CMS",1, 0.054, 0.298);
  ...
  // new MC file with gen values in it
  RF.LoadSimulated("HSParticles","/home/louise/g8K0Sig/code/convert/toy/out2/filepPi0_all.root","LinPolFit"); ///// change back to out3 after out12 test!!!!!!!!!!!
  ...
  //toy->LoadSimulated("HSParticles","/w/work0/home/louise/g8K0Sig/convert_output_MC/filepPi0_all.root","LinPolFit");
  // new MC file with gen values in it
  RF.LoadSimulated("HSParticles","/home/louise/g8K0Sig/code/convert/toy/out2/filepPi0_all.root","LinPolFit");    ///// change back to out3 after out12 test!!!!!!!!!!!
