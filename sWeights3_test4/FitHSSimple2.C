...
//root --hsfit FitHSSimple2.C
{
  ...
  ///////////////////////////////Load Variables
  //RF.SetUp().LoadVariable("M_pip_pim[0.45,0.55]"); // baseline results
  //RF.SetUp().LoadVariable("M_pip_pim[0.40,0.60]"); // Test 1
  //RF.SetUp().LoadVariable("M_pip_pim[0.475,0.52]"); // Test 2
  //RF.SetUp().LoadVariable("M_pip_pim[0.4625,0.535]"); // Test 3
  RF.SetUp().LoadVariable("M_pip_pim[0.48,0.515]"); // Test 4
  RF.SetUp().SetIDBranchName("fgID");

  /////////////////////////////Make Model Signal
  RF.SetUp().FactoryPDF("Gaussian::Signal(M_pip_pim, SIMm[0.495,0.40,0.60], SIMw[0.01,0.001,0.02] )");
