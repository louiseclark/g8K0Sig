...
void GetValuesForGraph() {
	...
	std::string path = "/home/louise/g8K0Sig/code/AllObsAmp3_test10/out1/";
	...
	for (int obsNum=0; obsNum<7; obsNum++) {
		...
		std::string xArrString = "st10"+obs[obsNum]+"x=[";
		std::string yArrString = "st10"+obs[obsNum]+"y=[";
		std::string yErrArrString = "st10"+obs[obsNum]+"y_err=[";
