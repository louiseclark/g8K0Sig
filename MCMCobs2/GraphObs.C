void GraphObs() {
	...
	TFile *infile = TFile::Open("/home/louise/g8K0Sig/code/MCMCobs2/out8.6/costhK0CMS0.67_Egamma1.85_/ResultsHSRooMcmcUniform2Seq.root");
	...
	for (int i=0; i<5; i++) {
		...
		g->GetHistogram()->SetMinimum(-1.0);
        g->GetHistogram()->SetMaximum(1.0);
        g->GetHistogram()->GetYaxis()->SetRangeUser(-1.0,1.0);
		g->Draw();
