...
//root --hsfit FitObsBins.C > out.txt
{
  ...
  RF.Bins().LoadBinVar("Egamma",4, 1.1, 2.1);
  ...
  //////////////////////////Load Weights
  RF.Data().LoadWeights("Signal","/home/louise/g8K0Sig/code/sWeights2/out_all_pi0K0_binned/Tweights.root");
  ...
  Proof::Go(&RF,8); // set to num bins for minuit fit
