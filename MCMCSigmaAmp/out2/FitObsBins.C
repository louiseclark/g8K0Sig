...
//root --hsfit FitObsBins.C | tee out.log
{
  ...
  /////////////////////////////Make Model Signal
  RF.SetUp().FactoryPDF("ObsFit::LinPolFit(phiK0,pol,polState,B)");
  ...
  RF.SetMinimiser(new RooMcmcUniform2Seq(2000,50,0.1)); // num of steps in final tree, burn in, inverse step size
