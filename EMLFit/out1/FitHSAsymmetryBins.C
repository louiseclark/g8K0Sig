...
//root --hsfit FitHSAsymmetryBins.C --BeamAsym.cxx
{
  ...
  RF->LoadBinVars("Egamma",3,1.1,2.1);
  ...
  RF->Factory("LinPolPDF::LinPolFit(phiK0,cosX,cosY,cosZ,pol,polState,B[0.0,-2.0,2.0],T[0.0,-2.0,2.0],Ox[0.0,-2.0,2.0],Oz[0.0,-2.0,2.0],R[0.0,-2.0,2.0])");
