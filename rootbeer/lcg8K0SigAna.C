...
//                                                                      *
void lcg8K0SigAna(int, char *,char *); // main func. (same name as this macro)
...
int main(int argc,char **argv){		
  ...
  lcg8K0SigAna(nEventsTot,InFileName,OutFileName);	//call user function
  return(0);
}
#endif
...
void lcg8K0SigAna(int nEvents, char *file, char *outFileName){   // main user function
...
void printUsage(){
  fprintf(stderr,"\nusage:\n\n");
  fprintf(stderr,"lcg8K0SigAna -h   Print this message\n\n");
  fprintf(stderr,"lcg8K0SigAna [-Nevents] <infile> <outfile.root> \n");
  fprintf(stderr,"lcg8K0SigAna [-Nevents] <-Lfilelist> <outfile.root> \n");
}
