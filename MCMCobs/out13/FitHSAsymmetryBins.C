...
//root --hsfit FitHSAsymmetryBins.C --LinPolPDF.cxx
{
  ...
  RF->SetOutDir("out13"); //give output directory
  //RF->SetBinnedFit();
  ...
  RF->Factory("LinPolPDF::LinPolFit(phiK0,cosX,cosY,cosZ,pol,polState,B[0.0,-1.0,1.0],T[0.248,-1.0,1.0],Ox[0.0,-1.0,1.0],Oz[-0.4755,-1.0,1.0],R[0.233,-1.0,1.0])");
